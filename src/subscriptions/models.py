...
SUBSCRIPTION_PERMISSIONS = [
    ("unlimited", "unlimited Perm"), # subscriptions.advanced
    ("foreign", "foreign Perm"),  # subscriptions.pro
    ("local", "local Perm")  # subscriptions.local,
]
...
def user_sub_post_save(sender, instance, *args, **kwargs):
    ...
    subscription_obj = user_sub_instance.subscrpition
    groups_ids = []
    ...
    if not ALLOW_CUSTOM_GROUPS:
        ...
        subs_groups = subs_qs.values_list("groups_ids", flat=True)
